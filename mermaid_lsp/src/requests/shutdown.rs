...
use crate::jsonrpc::{LspId, ServerResponse};
...
pub fn shutdown_request(id: LspId) -> ServerResponse {
    debug!("Shutting down the LSP with id: {:?}!", id);
    ServerResponse::new_result(Some(id), serde_json::Value::Null)
}
